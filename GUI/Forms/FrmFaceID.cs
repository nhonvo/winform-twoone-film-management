...
{
    public partial class FrmFaceID : Form
    {
        #region Variables
        ...
        CascadeClassifier faceCasacdeClassifier = new CascadeClassifier(@"C:\Users\vothu\Downloads\Winform_Movie\TwooneWinform\Resources\haarcascade_frontalface_alt.xml");
        ...
        private bool TrainImagesFromDir()
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Don't exist in database!!");
                    isTrained = false;
                    return false;
                }
            }
